...
sendVarToJS('eqType', 'btsniffer');
$eqLogics = eqLogic::byType('btsniffer');
$state = config::byKey('include_mode', 'btsniffer');
  ...
  <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
    ...
    <div class="eqLogicThumbnailContainer">
      ...
      foreach ($eqLogics as $eqLogic) {
        ...
        echo "<center>";
        echo '<img src="plugins/btsniffer/doc/images/btsniffer_icon.png" height="105" width="95" />';
        echo "</center>";
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                ...
                <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom de l'équipement btsniffer}}"/>
              </div>
            </div>
            <div class="form-group">
...
<?php include_file('desktop', 'btsniffer', 'js', 'btsniffer'); ?>
