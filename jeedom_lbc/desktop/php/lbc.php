...
sendVarToJS('eqType', 'lbc');
$eqLogics = eqLogic::byType('lbc');
    ...
    <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
        ...
        <span style="font-size : 1.1em;position:relative; top : 15px;word-break: break-all;white-space: pre-wrap;word-wrap: break-word;"><center>Ajouter</center></span>
                ...
                foreach ($eqLogics as $eqLogic) {
                    ...
                    echo "<center>";
                    echo '<img src="plugins/lbc/doc/images/lbc_icon.png" height="105" width="95" />';
                    echo "</center>";
...
<form class="form-horizontal">
    <fieldset>
        <div class="form-actions">
        <a class="btn btn-success btn-sm cmdAction" id="bt_addlbcInfo"><i class="fa fa-plus-circle"></i> {{Ajouter une commande info}}</a>
      </div>
  </fieldset>
</form>
...
<?php include_file('desktop', 'lbc', 'js', 'lbc'); ?>
