...
sendVarToJS('eqType', 'crues');
$eqLogics = eqLogic::byType('crues');
...
<div class="row row-overflow">
  ...
  <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
    <legend><i class="fa fa-table"></i>  {{Mes Crues}}
    </legend>
    <div class="eqLogicThumbnailContainer">
      ...
      foreach ($eqLogics as $eqLogic) {
        ...
        echo "<center>";
        echo '<img src="plugins/crues/doc/images/crues_icon.png" height="105" width="95" />';
        echo "</center>";
...
<?php include_file('desktop', 'crues', 'js', 'crues'); ?>
