...
sendVarToJS('eqType', 'opengarage');
$eqLogics = eqLogic::byType('opengarage');
    ...
    <div class="eqLogicThumbnailContainer">
      ...
      foreach ($eqLogics as $eqLogic) {
        ...
        if (in_array($test, $files)) {
          ...
          $path = 'opengarage_icon';
        }
        echo '<img src="plugins/opengarage/doc/images/' . $path . '.png" height="105" width="95" />';
        echo "</center>";
        ...
        <form class="form-horizontal">
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label">{{Nom du opengarage}}</label>
              <div class="col-sm-3">
                <input type="text" class="eqLogicAttr form-control" data-l1key="id" style="display : none;" />
                <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom de l'équipement opengarage}}"/>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label">{{Adresse IP du opengarage}}</label>
              <div class="col-sm-3">
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label">{{Clef opengarage}}</label>
              <div class="col-sm-3">
...
<?php include_file('desktop', 'opengarage', 'js', 'opengarage'); ?>
