...
sendVarToJS('eqType', 'myfitnesspal');
$eqLogics = eqLogic::byType('myfitnesspal');
  ...
  <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
    ...
    <div class="eqLogicThumbnailContainer">
      ...
      foreach ($eqLogics as $eqLogic) {
        ...
        echo "<center>";
        echo '<img src="plugins/myfitnesspal/doc/images/myfitnesspal_icon.png" height="105" width="95" />';
        echo "</center>";
        ...
        <form class="form-horizontal">
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <input type="text" class="eqLogicAttr configuration form-control" data-l1key="configuration" data-l2key="user" placeholder="votre utilisateur"/>
              </select>
            </div>
          </div>
...
<?php include_file('desktop', 'myfitnesspal', 'js', 'myfitnesspal'); ?>
