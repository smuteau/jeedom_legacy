...
sendVarToJS('eqType', 'airmon');
$eqLogics = eqLogic::byType('airmon');
$state = config::byKey('include_mode', 'airmon');
...
<div class="row row-overflow">
  ...
  <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
    ...
    <div class="eqLogicThumbnailContainer">
      ...
      <div class="cursor" id="bt_healthairmon" style="background-color : #ffffff; height : 120px;margin-bottom : 10px;padding : 5px;border-radius: 2px;width : 160px;margin-left : 10px;" >
        <center>
    ...
    <legend><i class="fa fa-table"></i>  {{Mes airmon}}
    </legend>
    <?php
    if (count($eqLogics) == 0) {
      echo "<br/><br/><br/><center><span style='color:#767676;font-size:1.2em;font-weight: bold;'>{{Aucun airmon détecté, démarrer un node pour ajout}}</span></center>";
    } else {
      ?>
      <div class="eqLogicThumbnailContainer">
        <?php
        ...
        foreach ($eqLogics as $eqLogic) {
          ...
          echo '<img src="plugins/airmon/doc/images/' . $path . '.png" height="105" width="95" />';
          echo "</center>";
          ...
          <form class="form-horizontal">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                ...
                <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom de l'équipement airmon}}"/>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label">{{IP de l'équipement}}</label>
              <div class="col-sm-3">
              ...
              <div class="form-group">
              <label class="col-sm-3 control-label">{{MAC de l'équipement}}</label>
              <div class="col-sm-3">
...
<?php include_file('desktop', 'airmon', 'js', 'airmon'); ?>
