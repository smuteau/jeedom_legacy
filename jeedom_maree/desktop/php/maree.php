...
sendVarToJS('eqType', 'maree');
$eqLogics = eqLogic::byType('maree');
...
<div class="row row-overflow">
  ...
  <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
    <legend><i class="fa fa-table"></i>  {{Mes Marées}}
    </legend>
    <div class="eqLogicThumbnailContainer">
      ...
      foreach ($eqLogics as $eqLogic) {
        ...
        echo "<center>";
        echo '<img src="plugins/maree/doc/images/maree_icon.png" height="105" width="95" />';
        echo "</center>";
...
<?php include_file('desktop', 'maree', 'js', 'maree'); ?>
